...
def xafs_step_scan(detectors, energy_motor, 
                   pre_edge_start, pre_edge_stop, pre_edge_step,
                   edge_start, edge_stop, edge_step,
                   post_edge_start, post_edge_stop, post_edge_step,
                   md=None):
    """
...
def transmission_xafs(sample_name, energy_motor, i0_detector, it_detector, ir_detector=None,
                      edge_energy=8000, scan_range=(-200, 800), md=None):
    """
...
def fluorescence_xafs(sample_name, energy_motor, i0_detector, fluorescence_detector,
                      edge_energy=8000, scan_range=(-200, 800), md=None):
    """
...
def xafs_with_temperature(sample_name, energy_motor, detectors, temp_controller,
                         temperatures, edge_energy=8000, md=None):
    """
...
def energy_calibration_scan(detectors, energy_motor, reference_foil_energy, 
                           scan_range=(-20, 20), num_points=81, md=None):
    """
